...
chmod +x /home/optergy/deb-optergy/profiles/production-non-raid.postinst
...
cat /home/optergy/deb-optergy/profiles/production-non-raid.packages
#build-simple-cdd --conf default.conf --local-packages /home/optergy/deb-optergy/debs/ -p stage
build-simple-cdd --conf /home/optergy/deb-optergy/production-non-raid.conf -p production-non-raid
