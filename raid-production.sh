...
chmod +x /home/optergy/deb-optergy/profiles/raid-production.postinst
...
cat /home/optergy/deb-optergy/profiles/raid-production.packages
#build-simple-cdd --conf default.conf --local-packages /home/optergy/deb-optergy/debs/ -p stage
build-simple-cdd --conf /home/optergy/deb-optergy/raid-production.conf -p raid-production
